...
📂 File: [`HypeBike_DFD.drawio`](./docs/HypeBike_DFD.drawio)

📸 DFD Level 0 Excerpt:
![DFD Level 0](./docs/screenshots/dfd_level0.png)

📸 DFD Level 1 Excerpt:
![DFD Level 1](./docs/screenshots/dfd_level1.png)
...
📂 File: [`HypeBike_ERD.drawio`](./docs/HypeBike_ERD.drawio)
